...
//		}
    ...
    @Override
    public List<Goods> getGoodsByPageAndTid(int offset, int size, Integer tid)
    {
        return goodsRepository.getGoodsByPageAndTid(offset, size, tid);
    }

    @Override
    public long countGoodsByTid(Integer tid)
    {
        return goodsRepository.countGoodsByTid(tid);
    }
